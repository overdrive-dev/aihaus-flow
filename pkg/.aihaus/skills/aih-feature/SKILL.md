...
See `annexes/agent-routing.md` Step 9 for migration-reviewer conditional dispatch + full review loop. CRITICAL/HIGH → spawn `code-fixer` + re-run both; cap 2 iterations.
