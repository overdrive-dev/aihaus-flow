...
## Protocol
0. **Guard bypasses**: `export AIHAUS_TDD_GUARD=0` — M028/S2: aih-quick is exploratory; bypass tdd-guard for this session. `export AIHAUS_CALIBRATE_GUARD=0` — M029/S2: aih-quick is exploratory; bypass calibrate-guard for this session.
...
6. **Commit**: Atomic commit with descriptive message. Then: `unset AIHAUS_TDD_GUARD` — M028/S2: bound to aih-quick session, prevent leakage. `unset AIHAUS_CALIBRATE_GUARD` — M029/S2: bound to aih-quick session, prevent leakage.
