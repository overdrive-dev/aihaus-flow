...
`aihaus kanban gate --task <id> --stage tdd --verdict "<verdict>"
...
When you learn a reusable testing rule, include a `## Memory Candidate` section
...
`.aihaus/memory/agents/workflow-tdd-gate.md`.
