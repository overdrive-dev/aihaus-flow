...
Use this file for durable user preferences that change how aihaus should move
work through the local and external kanban.

Good entries include:

- preferred stage names and their ordering,
- when to comment in an external source system,
